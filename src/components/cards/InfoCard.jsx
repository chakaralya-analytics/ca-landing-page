            ...
            <section className="bg-white ">
                <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                    <div className="col-span-2 mb-8">
                        ...
                        <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl text-gray-700">
                            Trusted by over 10 million users and 5,000 teams ans businesses.
                        </h2>
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                            Our rigorous security and compliance standards are
                            at the heart of all we do. We work tirelessly to
                            provide you and your customers the best in the market.
                        </p>
                    ...
                    <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <p className="font-light text-gray-500 dark:text-gray-400">
                                Chakaralaya Analytics, with zero maintenance downtime
                            </p>
                        </div>
                        <div>
                            <svg
                            ...
                            <p className="font-light text-gray-500 dark:text-gray-400">
                                Trusted by over 10 milion users around the
                                world
                            </p>
                        </div>
                        <div>
